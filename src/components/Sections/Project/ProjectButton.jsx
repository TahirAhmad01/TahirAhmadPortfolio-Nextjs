            ...
            <span className="flex m-auto">
              {buttonList.map((btn, idx) => (
                <HorizontalScrollItem id={idx} key={idx}>
                  <button
                    className={`mx-1 my-1  py-1 px-4 capitalize bg-[#e2e8f0] hover:[#cbd5e1] rounded-3xl text-sm min-w-[4.5rem]  ${activeBtn === btn.category ? "bg-gradient-to-r from-green-400 via-blue-500 to-purple-600 hover:bg-gradient-to-bl text-white" : "dark:text-black"}`}
